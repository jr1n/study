...
public class Admin implements IAdmin, User {
	...
	public void adddummy() {
		School.lunch.add(new Meal("현  미  밥", "시래기된장국", "너 비  아 니", "시금치 무침", " 깍  두  기 "));
		School.lunch.add(new Meal("잡  곡  밥", "김 치  찌 개", "오징어불고기", "계 란 말 이", "배 추  김 치"));
		School.lunch.add(new Meal("검 은 콩밥", "선   지   국", "제 육  볶 음", "무 말 랭 이", " 겉  절  이 "));
		School.lunch.add(new Meal("현  미  밥", " 소고기무국 ", " 닭  강  정 ", "어 묵 볶 음", "볶 음  김 치"));
		School.lunch.add(new Meal("흰  쌀  밥", " 토  란  국 ", " 돈  까  스 ", "계란 후라이", " 흰  김  치 "));
	}
